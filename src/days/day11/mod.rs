...
fn save_grid_to_disk(map: &Grid, output: &Path) {
...
impl Challenge for Day11 {
    fn run_ex1(&mut self) -> String {
        ...
        let path = PathBuf::new().join("debug").join("day11.png");
    ...
    fn run_ex2(&mut self) -> String {
        let mut grid = Grid::from(parse_input_raw!());
        grid.step_until_all_flashing().to_string()
    }
}
...
mod tests {
    ...
    use crate::{create_day_tests, days::day11::save_grid_to_disk};

    use super::Grid;

    create_day_tests!("11", "1603", "222");
    ...
    fn test_small_sample() {
        ...
        let path = PathBuf::new().join("debug").join("day11-small-sample.png");
        save_grid_to_disk(&grid, &path);
    ...
    fn test_sample() {
        ...
        let path = PathBuf::new().join("debug").join("day11-sample.png");
        save_grid_to_disk(&grid, &path);
    }
